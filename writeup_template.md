...
Below is a hand drawn diagram listing the locations of the constants a and d constants.  The a's are the displacement of the next joint z axis from the previous joint z axis along the x axis.  The d constant is the displacement of the next joint x axis from the prevous joint x axis along the z axis.
